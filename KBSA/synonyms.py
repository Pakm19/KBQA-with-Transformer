...
stopwords = open(r'C:\Users\Thanh\anaconda3\envs\Simple_ViQA\QAwIR\bert-vietnamese-question-answering\resources\stopwords_small.txt').read().split('\n')
stopwords = set([w.replace(' ','_') for w in stopwords])
punct_set = set([c for c in string.punctuation]) | set(['“','”',"...","–","…","..","•",'“','”'])

with open(r'C:\Users\Thanh\anaconda3\envs\Simple_ViQA\QAwIR\bert-vietnamese-question-answering\resources\bigram.txt') as f:
    data = f.read().split('\n')
...
map_synonym = json.load(open(r'C:\Users\Thanh\anaconda3\envs\Simple_ViQA\QAwIR\bert-vietnamese-question-answering\resources\synonym.json'))
